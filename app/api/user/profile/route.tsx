...
import { UserRepositoryImpl } from '@/be/infrastructure/repository/supabase/user';
...
export async function DELETE(_request: NextRequest) {
   ...
   const repository = new UserRepositoryImpl(env.nextPublicSupabaseUrl, env.supabaseSecret);
