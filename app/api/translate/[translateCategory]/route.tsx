...
export async function POST(request: NextRequest, { params }: { params: Promise<{ translateCategory: string }> }) {
   try {
      ...
      if (translateCategory === 'sentence') {
         ...
         return handleFeedbackRequest(question, answer, level, selectedOptions, language);
      } else {
